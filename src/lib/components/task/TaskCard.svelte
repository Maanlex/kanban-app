...
<ContextMenu.Root>
    ...
    {#if ($contextMenuUp == task.id)}
        <ContextMenu.Content class="menu bg-base-200 w-56 rounded-box"> 
            <ContextMenu.Item> 
                <button class="btn btn-block btn-ghost justify-start" on:click={() => {editDialogTrigger.click()}} tabindex="0">
            ...
            <ContextMenu.Item> 
                <button class="btn btn-block btn-ghost justify-start" on:click={() => {deleteDialogTrigger.click()}}>
